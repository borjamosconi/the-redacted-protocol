      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <a href="https://github.com/whalesconspiracy-33/the_redacted_protocol" target="_blank" rel="noopener" className="flex items-center gap-2 text-xs text-rd-muted/40 hover:text-rd-red/70 transition-colors tracking-widest">
