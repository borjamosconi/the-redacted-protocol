...
exports.connection = new web3_js_1.Connection(SOLANA_RPC);
...
const umi = (0, umi_bundle_defaults_1.createUmi)(SOLANA_RPC);
...
const logTx = exports.connection.onLogs(programId_1.PROGRAM_ID, async (logs, ctx) => {
    ...
    if (parsedData.reserve2 > 80000000000) {
...
const createRaydium = async (mint1) => {
    const amountOne = 1000000000000;
    const amountTwo = 1000000000000;
